                    ...
                    <div class="reading-question">
                        <form id="exam-form">
                            @foreach($questions as $q)
                                <div class="q-block" data-qid="{{ $q->id }}" data-order="{{ $q->order }}" data-part="{{ $q->part_number ?? 1 }}" data-skill="{{ $q->section_skill ?? ($exam->skill ?? 'reading') }}">
...
<script>
    (function () {
        ...
        let activeSkill = uniqueSkills[0] || normalizeSkill('{{ $exam->skill ?? 'reading' }}');
